...
public:
    ...
    void Setup(float tile_size, sf::Vector2f grid_offset);
    void HandleEvent(const sf::Event& event, const sf::RenderWindow& window, const Tilemap& tilemap);
    void Update(const sf::RenderWindow& window, const Tilemap& tilemap);
